...
<head>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="${ctx.contextPath}/static/fontawesome/css/font-awesome.min.css">
  <!-- Ionicons -->
  <link rel="stylesheet" href="${ctx.contextPath}/static/ionicons/css/ionicons.min.css">
  <!-- Theme style -->
  <link rel="stylesheet" href="${ctx.contextPath}/static/adminlte/css/AdminLTE.min.css">
        ...
        <ul class="nav navbar-nav">
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <!-- User Image -->
                        <img src="${ctx.contextPath}/static/adminlte/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                      </div>
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="${ctx.contextPath}/static/adminlte/img/user2-160x160.jpg" class="user-image" alt="User Image">
