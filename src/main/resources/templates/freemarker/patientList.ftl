  ...
  <section class="vbox">
    <header class="bg-dark dk header navbar navbar-fixed-top-xs">
      <div class="navbar-header aside-md">
        ...
        <a href="#" class="navbar-brand" data-toggle="fullscreen"><img src="images/logo.png" class="m-r-sm">护理系统</a>
            ...
            <section class="w-f scrollable">
              <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="5px" data-color="#333333">
                ...
                <nav class="nav-primary hidden-xs">
                  <ul class="nav">
                    <li  class="active">
                      <a href="toPatientList"   class="active">
          ...
          <section class="vbox">          
            <section class="scrollable padder">
              <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                <li><a href="#"><i class="fa fa-home"></i>病人信息</a></li>
                <li class="active">病人列表</li>
              </ul>
              <div class="m-b-md">
                <h3 class="m-b-none">病人列表</h3>
                <small>病人列表信息</small>
              </div>
             ...
             <div class="panel panel-default">
			  ...
			  <#list resultList as PatientInfo>
				<tr>
				<th>${PatientInfo_index+1}</th>
				<th>${PatientInfo.name}</th>
				<th>${PatientInfo.careLevel}</th>
				</tr>
				</#list>
			  </table>
			</div>
